...
![Fig. S7 Trend accuracy assessment for all age groups combined. Color indicates model, faceted by pathogen.](../output/figs/supp/state_trend_accuracy.png)

![Fig. S8 Trend accuracy assessment for all age groups combined. Color indicates model, faceted by pathogen, broken down by trend.](../output/figs/supp/state_trend_accuracy_by_category.png)

![Fig. S9 95% interval coverage across all age groups (combined). Colors indicate model, horizontal dashed line indicates the nominal interval coverage, e.g. for a perfectly well-calibrated nowcast we would expect 95% of the observations to fall within the 95% prediction interval.](../output/figs/supp/state_coverage.png)

![Fig. S10 Weighted interval score over time across all age groups (combined) throughout the 2024-2025 season, alongside epidemiological curve showing the total number of ED visits due to each pathogen over time. Color indicates model, each row is a different pathogen.](../output/figs/supp/state_wis_t.png)

![Fig. S11 Zero-week horizon nowcasts for each model for Broad Acute Respiratory incidence for all age groups combined. Color indicates model, shading indicates WIS component.](../output/figs/supp/bar_horizon_0_00+.png)

![Fig. S12 Zero-week horizon nowcasts for each model for RSV for all age groups combined. Color indicates model, shading indicates WIS component.](../output/figs/supp/rsv_horizon_0_00+.png)

![Fig. S13 Zero-week horizon nowcasts for each model for influenza for all age groups combined. Color indicates model, shading indicates WIS component.](../output/figs/supp/flu_horizon_0_00+.png)

![Fig. S14 Zero-week horizon nowcasts for each model for COVID-19 for all age groups combined. Color indicates model, shading indicates WIS component.](../output/figs/supp/covid_horizon_0_00+.png)

![Fig. S15 Comparison of the weighted interval score different methods of producing weekly nowcasts from daily data for the state-level (combined across age group) nowcasts. Color indicates model, shading indicates WIS component.](../output/figs/fig3_state_nowcast_comp_alt.png)
...
![Fig. S42 Comparison of the weighted interval score for different methods of producing weekly nowcasts from daily data for the age group nowcasts. Color indicates model, shading indicates WIS component.](../output/figs/fig4_ag_nowcast_alt.png) ![Fig. SX Comparison of the weighted interval score for the original MAPDH method and the revised method. Color indicates model, shading indicates WIS component.](../output/figs/fig4_ag_nowcast_comp.png)
